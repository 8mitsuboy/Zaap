...
### カバレッジ基準
その対象をどこまで確認したら十分かのルール

> テスト条件がスコープ、カバレッジ基準がそのスコープの完了条件
...
カバレッジ基準が「その対象をどこまで確認するか」

### カバレッジ基準の例
テスト条件: 送料計算が正しく機能すること
<br />
**会員 × 購入金額 × 支払い方法の組み合わせを据えて確認する**
